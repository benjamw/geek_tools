	...
	<div class="row" id="hashes">
		<div class="col-md table-responsive">
			...
			<div class="form-group">
				...
				<label for="hash_value">Input String:</label> <label><input type="checkbox" name="hash_raw" id="hash_raw" <?= ($_REQUEST['hash_raw'] ?? false) ? 'checked="checked"' : '' ?>> Hash Raw Bytes</label>
